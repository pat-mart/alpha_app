...
class _PlanCardState extends State<PlanCard> {
  ...
  void initState() {
    ...
    objFuture = plan.getObjInfo(
        1, 0, widget.httpsClient, plan.timespan.startDateTime, true);
          ...
          children: [
            Text(
                ...
                plan.timespan.numDays > 1
                    ...
                    : dayFormat.format(plan.timespan.startDateTime),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 12),
                          child: Text(
                              'at coordinate (${plan.latitude}°, ${plan.longitude}°)',
                              style: TextStyle(
                                  color:
                            ...
                            child: FutureBuilder(
                                ...
                                builder: (context, snapshot) {
                                  if (snapshot.hasData &&
                                      ...
                                      snapshot.data!.hoursVis.length >= 2) {
                                    if (snapshot.data!.hoursVis[0]
                                        .startsWith('[')) {
                                      snapshot.data!.hoursVis[0] = snapshot
                                          .data!.hoursVis[0]
                                          .substring(1, 6);
                                      snapshot.data!.hoursVis[1] = snapshot
                                          .data!.hoursVis[1]
                                          .substring(1, 6);
                                    } else {
                                      snapshot.data!.hoursVis[0] = snapshot
                                  ...
                                  bool usedFilters = plan.azMin != -1 ||
                                      ...
                                      plan.altThresh != -1;
                                  String filterMsg =
                                      "Not visible within filters";

                                  if (snapshot.connectionState ==
                                          ConnectionState.done &&
                                      usedFilters &&
                                      snapshot.data!.hoursSuggested.length >=
                                          2) {
                                    filterMsg =
                                        "Within filters from ${snapshot.data!.hoursSuggested[0]} to ${snapshot.data!.hoursSuggested[1]}";
                                  }
                                  ...
                                  if (snapshot.hasData &&
                                      snapshot.data != null &&
                                      snapshot.data!.hoursVis[0] == -1 &&
                                      snapshot.connectionState ==
                                          ConnectionState.done) {
                                    return Text('Object is not visible',
                                        style: TextStyle(
                                      ...
                                      children: [
                                        Padding(
                                          padding: const EdgeInsets.only(
                                              bottom: 8.0),
                                          child: Text(
                                              'Peaks at (${snapshot.data!.peakAlt.toStringAsFixed(2)}°, ${snapshot.data!.peakBearing.toStringAsFixed(2)}°) at ${snapshot.data!.peakTime.substring(11, 16)}',
                                              style: TextStyle(
                                                  color: CupertinoColors
                                                      .secondaryLabel.darkColor,
                                                  fontSize: 18)),
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.only(
                                              bottom: 8.0),
                                          child: Text(
                                              'Visible from ${(snapshot.data!.hoursVis[0])} to ${(snapshot.data!.hoursVis[1])}',
                                              style: TextStyle(
                                                  color: CupertinoColors
                                                      .secondaryLabel.darkColor,
                                                  fontSize: 18)),
                                      ...
                                      return const Padding(
                                        ...
                                        child: Row(children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                                'No clear weather for this plan',
                                                style: TextStyle(
                                                    color: CupertinoColors
                                                        .systemRed,
                                                    fontSize: 18)),
