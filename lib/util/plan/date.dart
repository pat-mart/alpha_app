...
sealed class Date {
  ...
  static dynamic hourToDt(DateTime startDate, double hour, [double utcOffset = 0]){
    if(hour == -1){
      return hour;
    }
    ...
    return DateTime.utc(startDate.year, startDate.month, startDate.day, startHour, startMinute);
  }

  static List<dynamic> hoursToDtList(DateTime startDate, List<double> hours, [double utcOffset = 0]){
