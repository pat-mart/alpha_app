...
class SearchScreen extends StatefulWidget {
  ...
  const SearchScreen(
      {super.key, required this.initialQueryValue, required this.isEdit});
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Future<void> csvFuture = SearchViewModel().loadCsvData();
              ...
              navigationBar: CupertinoNavigationBar(
                ...
                trailing: CupertinoButton(
                    ...
                    onPressed: (searchVm.previewedResult != null &&
                        ...
                        : null,
                    child:
                        const Text('Select', overflow: TextOverflow.visible)),
              ),
              child: SafeArea(
                  child: Container(
                      margin:
                      ...
                      child: Column(children: [
                        ...
                        Expanded(
                            child: (searchVm.resultsList.isEmpty &&
