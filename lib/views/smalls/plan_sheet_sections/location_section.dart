...
class _LocationSectionState extends State<LocationSection>
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) async {
    ...
    if (state == AppLifecycleState.resumed) {
      ...
      if (!widget.locationVm.serviceEnabled &&
          widget.locationVm.isUsingService) {
          ...
          return CupertinoFormSection.insetGrouped(
              ...
              children: [
                FutureBuilder(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return CupertinoFormRow(
                        prefix: Text('Use this location',
                            style: TextStyle(
                                color: locationVm.serviceEnabled
                                    ? CupertinoColors.white
                                    : CupertinoColors.inactiveGray.darkColor)),
                        helper: !locationVm.serviceEnabled
                        ...
                        child: CupertinoSwitch(
                          onChanged: (!locationVm.serviceEnabled)
                              ? null
                              : (newVal) async {
                                  // DO NOT TOUCH
                          ...
                          value: locationVm.isUsingService &&
                              locationVm.serviceEnabled,
                        ));
                  },
                ),
                CupertinoTextFormFieldRow(
                    ...
                    placeholder: (locationVm.serviceEnabled &&
                            locationVm.isUsingService &&
                            locationVm.locationData != null)
                        ? '${locationVm.locationData?.latitude?.toStringAsFixed(4) ?? 0.000}°'
                        : '0.000°...',
                ...
                CupertinoTextFormFieldRow(
                    ...
                    placeholder: (locationVm.serviceEnabled &&
                            locationVm.isUsingService &&
                            locationVm.locationData != null)
                        ? '${locationVm.locationData?.longitude?.toStringAsFixed(4) ?? 0.000}°'
                        : '0.000°...',
                    enabled: !locationVm.isUsingService,
                    keyboardType: const TextInputType.numberWithOptions(
                        signed: true, decimal: true),
